...
export function renderVoluntarios() {
    ...
    const vagasFiltradas = mockData.vagas.filter(v => 
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-5 hover:border-blue-300 hover:shadow-md transition-all flex flex-col h-full">
                            ...
                            <div class="space-y-3 mb-5">
                                ...
                                <div class="flex items-center text-sm text-gray-500 gap-2">
                                    ...
                                    <span>${v.inscritos} / ${v.vagas} inscritos</span>
                                </div>
                                
                                <div class="w-full bg-gray-100 rounded-full h-2 mt-2 overflow-hidden">
                                    <div class="bg-blue-600 h-2 rounded-full transition-all duration-500" style="width: ${(v.inscritos / v.vagas) * 100}%"></div>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2 mt-auto pt-4 border-t border-gray-100">
                                ...
                                <button class="flex-1 py-2 bg-blue-50 text-blue-700 border border-blue-200 font-medium rounded-lg hover:bg-blue-100 transition-colors flex justify-center items-center gap-2" onclick="window.showToast('A Edição será implementada com a API', 'info')">
